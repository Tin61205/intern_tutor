...
from app.db.database import close_db_connection, get_db
...
async def lifespan(app: FastAPI):
    ...
    # 2. Dọn dẹp Database (Graceful Shutdown)
    ...
    print(f"🛑 {settings.APP_NAME} is shutting down safely!")
...
app = FastAPI(
    ...
    * **Tối ưu hóa**: Redis Caching siêu tốc.
    ...
    },  # Ẩn danh sách Model rườm rà dưới đáy Swagger
)

from fastapi.middleware.cors import CORSMiddleware

# Đăng ký CORS Middleware (Rất quan trọng cho Security)
app.add_middleware(
    CORSMiddleware,
...
async def health_check(db: SessionDep):
    ...
    if health_status["status"] == "unhealthy":
        # Phải import Response ở trên cùng hoặc dùng JSONResponse
